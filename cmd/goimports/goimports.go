...
import (
	...
	"github.com/bafko/tools/internal/imports"
)
...
func init() {
	...
	flag.StringVar(&options.LocalPrefix, "local", "", "put imports beginning with this string before 3rd-party and group packages; comma-separated list")
	flag.StringVar(&options.GroupPrefix, "group", "", "put imports beginning with this string before 3rd-party and after local packages; comma-separated list")
